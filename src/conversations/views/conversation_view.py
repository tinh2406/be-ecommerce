...
from conversations.domains import ConversationDomain
...
class ConversationViewSet(ModelViewSet):
    ...
    def update(self, request, *args, **kwargs):
        conversation = ConversationDomain.get(kwargs.get("pk"))
        ...
        ConversationDomain.update(conversation, serializer.validated_data)
    ...
    def list(self, request, *args, **kwargs):
        ...
        data = ConversationDomain.search_conversation(
    ...
    def list_user(self, request, *args, **kwargs):
        ...
        data = ConversationDomain.search_user(query_serializer.validated_data)
        return Response(data)

    def retrieve(self, request, *args, **kwargs):
        conversation, unread = ConversationDomain.retrieve(
